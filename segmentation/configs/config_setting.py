...
class setting_config:
    ...
    infer_data = "test"
    pred_save_dir = os.path.join("preds", infer_data)
    # infer_data_path = "./data/size345_clean/"
    infer_data_path = "./data/test/"

    ################## for subset sampling and k-fold cross-validation
    data_path1 = "./data/size1-5/size1/"
    data_path2 = "./data/size1-5/size2/"
    data_path3 = "./data/size1-5/size3/"
    data_path4 = "./data/size1-5/size4/"
    data_path5 = "./data/size1-5/size5/"

    data_path6 = "./data/deepsmote/size1-5/size1/"
    data_path7 = "./data/deepsmote/size1-5/size2/"
    data_path8 = "./data/deepsmote/size1-5/size3/"
    data_path9 = "./data/deepsmote/size1-5/size4/"
    data_path10 = "./data/deepsmote/size1-5/size5/"

    ckpt_name = "sizes_all"
    work_dir = 'ckpts/' + ckpt_name
